...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../emscripten_out/arculator.data';
...
Module['FS_createPath']("/ddnoise", "35", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_../emscripten_out/arculator.data');

      };
      Module['addRunDependency']('datafile_../emscripten_out/arculator.data');
    ...
    loadPackage({"files": [{"filename": "/arc.cfg", "start": 0, "end": 101}, {"filename": "/ddnoise/35/motoron.wav", "start": 101, "end": 14195, "audio": 1}, {"filename": "/ddnoise/35/seek3i.wav", "start": 14195, "end": 56725, "audio": 1}, {"filename": "/ddnoise/35/seek2i.wav", "start": 56725, "end": 73741, "audio": 1}, {"filename": "/ddnoise/35/stepi.wav", "start": 73741, "end": 77953, "audio": 1}, {"filename": "/ddnoise/35/seek1i.wav", "start": 77953, "end": 84589, "audio": 1}, {"filename": "/ddnoise/35/motoroff.wav", "start": 84589, "end": 103259, "audio": 1}, {"filename": "/ddnoise/35/motor.wav", "start": 103259, "end": 148165, "audio": 1}, {"filename": "/ddnoise/35/stepo.wav", "start": 148165, "end": 150391, "audio": 1}, {"filename": "/ddnoise/35/seek3o.wav", "start": 150391, "end": 192749, "audio": 1}, {"filename": "/ddnoise/35/seek1o.wav", "start": 192749, "end": 197581, "audio": 1}, {"filename": "/ddnoise/35/seek2o.wav", "start": 197581, "end": 213963, "audio": 1}], "remote_package_size": 213963, "package_uuid": "e9720cc6-3119-4bfd-87b8-c4f3a5c97ce5"});
...
var ASM_CONSTS = {
  104336: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 104473: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 104697: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 105190: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 105258: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); }},  
 106910: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']);},  
 ...
 112045: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 112138: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 112207: function() {return window.innerWidth;},  
 112237: function() {return window.innerHeight;}
};
...
/** @type {function(...*):?} */
var _sdl_enable_mouse_capture = Module["_sdl_enable_mouse_capture"] = createExportWrapper("sdl_enable_mouse_capture");

/** @type {function(...*):?} */
var _sdl_disable_mouse_capture = Module["_sdl_disable_mouse_capture"] = createExportWrapper("sdl_disable_mouse_capture");

/** @type {function(...*):?} */
var _arc_pause_main_thread = Module["_arc_pause_main_thread"] = createExportWrapper("arc_pause_main_thread");

/** @type {function(...*):?} */
var _arc_resume_main_thread = Module["_arc_resume_main_thread"] = createExportWrapper("arc_resume_main_thread");

/** @type {function(...*):?} */
var _arc_do_reset = Module["_arc_do_reset"] = createExportWrapper("arc_do_reset");

/** @type {function(...*):?} */
var _arc_load_config_and_reset = Module["_arc_load_config_and_reset"] = createExportWrapper("arc_load_config_and_reset");

/** @type {function(...*):?} */
var _arc_disc_change = Module["_arc_disc_change"] = createExportWrapper("arc_disc_change");

/** @type {function(...*):?} */
var _arc_disc_eject = Module["_arc_disc_eject"] = createExportWrapper("arc_disc_eject");

/** @type {function(...*):?} */
var _arc_fast_forward = Module["_arc_fast_forward"] = createExportWrapper("arc_fast_forward");

/** @type {function(...*):?} */
var _arc_renderer_reset = Module["_arc_renderer_reset"] = createExportWrapper("arc_renderer_reset");

/** @type {function(...*):?} */
var _arc_set_display_mode = Module["_arc_set_display_mode"] = createExportWrapper("arc_set_display_mode");

/** @type {function(...*):?} */
var _arc_set_dblscan = Module["_arc_set_dblscan"] = createExportWrapper("arc_set_dblscan");

/** @type {function(...*):?} */
var _arc_set_sound_filter = Module["_arc_set_sound_filter"] = createExportWrapper("arc_set_sound_filter");

/** @type {function(...*):?} */
var _arc_enter_fullscreen = Module["_arc_enter_fullscreen"] = createExportWrapper("arc_enter_fullscreen");
